...
const UnderConstruction = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center mt-40 mb-40">
            ...
            <img src="https://images.unsplash.com/photo-1589939705384-5185137a7f0f?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Under Construction" className="mb-4 w-96" />
